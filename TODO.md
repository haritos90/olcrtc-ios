...
| 318 | P3 | S | observability | Orphaned log files after #294: `ip.log`/`speed.log` (now `diagnostics.log`) and the old shared `containerLogs.log` linger in Documents/logs — delete or migrate on startup |
